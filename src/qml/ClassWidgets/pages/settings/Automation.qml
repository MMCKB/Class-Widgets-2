...
FluentPage {
    ...
    readonly property var triggerOptions: AppCentral.automationProfiles.triggerOptions
    readonly property var triggerKeys: triggerOptions.map(function(option) { return option.id })
    readonly property var triggerNames: triggerOptions.map(function(option) { return option.title })
    readonly property var actionOptions: AppCentral.automationProfiles.actionOptions
    readonly property var actionKeys: actionOptions.map(function(option) { return option.id })
    readonly property var actionNames: actionOptions.map(function(option) { return option.title })
                                ...
                                delegate: Frame {
                                    ...
                                    ColumnLayout {
                                        ...
                                        TextField {
                                            id: actionProgram
                                            Layout.fillWidth: true
                                            visible: actionType.automationValue === "run_program"
