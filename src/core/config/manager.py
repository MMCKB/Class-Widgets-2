...
from .model import AppConfig, ScheduleConfig, PreferencesConfig, PluginsConfig, LocaleConfig, InteractionsConfig, \
    ConfigBaseModel, NetworkConfig, NotificationsConfig, TimeConfig, CentralControlConfig, SceneModesConfig
...
class RootConfig(ConfigBaseModel):
    ...
    scene_modes: SceneModesConfig = Field(default_factory=SceneModesConfig)
